...
const agregarTareaBTN = document.querySelector(".task-submit");
const contenedorTareas = document.querySelector(".container-tasks");
const formularioTexto = document.querySelector(".task-text");
